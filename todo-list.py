...
# DONE : ADD tempNews to a bigger list like gp.se + idg.se
# DONE: Ändra så att man kollar efter title och inte label
# DONE: Markera om en artikel finns med i register
# DONE: MOVE TODO TO another file
# DONE: Städa kod!
